          ...
          <!-- #include file ="../menu.inc" -->
            ...
            <form id="principal" runat="server" class="form-horizontal">
               <div class="form-group">
                ...
                <asp:GridView runat="server" id="gridListaCidade" AutoGenerateColumns = "false" CssClass="table table-bordered table-hover">
               <Columns>
                    <asp:BoundField DataField="cidade" HeaderText="CIDADE" />
                    <asp:BoundField DataField="estado" HeaderText="ESTADO" />
                    <asp:BoundField DataField="siglaEstado" HeaderText="SIGLA" >       
